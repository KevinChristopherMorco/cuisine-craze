...
const SearchCard = ({
  ...
  return (
    <Link
      ...
      className="w-[95%] mx-auto flex justify-between shadow-md shadow-[var(--shadow-color)] rounded-xl hover:scale-105 transition dark:shadow dark:shadow-[var(--accent-color)] xl:w-[90%]"
    >
      <div className="basis-[35%] md:basis-[30%] xl:basis-[25%]">
        <img src={mealImg} alt={mealName} className="rounded-xl" />
      </div>
      <div className="py-1 flex flex-col justify-around basis-[60%] text-lg font-bold md:basis-[65%] md:text-2xl lg:text-3xl xl:basis-[70%] xl:text-4xl">
        <p className="line-clamp-2">{mealName}</p>
        <div className="py-2 flex items-center gap-x-6 ">
          <ul className="flex gap-x-4 text-[0.8rem] md:gap-x-10 md:text-lg lg:text-2xl xl:text-3xl">
